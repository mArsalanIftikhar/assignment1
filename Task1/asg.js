...
var fruits, vegetables, grocery;
let dozen, bill, aft_dis_bill, discount, payment_method, Credit_Card = 1, Dedit_Card = 2, Cash = 3, Mobile_Wallet = 4;
...
-----------------------------------------------------------------------\n
    ...
    if (fruits == "A" || fruits == "a") {
        ...
        if (dozen >= 4) {
            ...
            for (let i = 1; i <= 3; i++) {
                payment_method = parseInt(prompt(`Choose Your Preferred Payment Method:
                ...
                if (payment_method == 1 ||
                    ...
                    payment_method == 4) {
                    if (payment_method == 1) {
                        console.log(`Thank you! You Have Selected Credit Card For Your Payment.`);
                    }
                    else if (payment_method == 2) {
                        console.log(`Thank you! You Have Selected Debit Card For Your Payment.`);
                    }
                    else if (payment_method == 3) {
                        console.log(`Thank you! You Have Selected Cash For Your Payment.`);
                    }
                    else if (payment_method == 4) {
                        console.log(`Thank you! You Have Selected Mobile Wallet For Your Payment.`);
                    }
                    else {
